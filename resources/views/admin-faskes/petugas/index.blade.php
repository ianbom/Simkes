   ...
   <div x-data="faskesUserTable">
        ...
        <div class="panel mt-6">
            <div class="flex items-center justify-between mb-5">
                <h5 class="font-semibold text-lg dark:text-white-light">Daftar Pengguna Faskes</h5>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex items-center">
                                        @if($user->profile_pic_url)
                                            <img src="{{ $user->profile_pic_url }}" alt="{{ $user->name }}" class="w-8 h-8 rounded-full mr-3 object-cover">
                                        @else
                                            <div class="w-8 h-8 rounded-full bg-gray-300 flex items-center justify-center mr-3">
                                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="text-gray-600">
                                                    <path d="M16 7C16 9.20914 14.2091 11 12 11C9.79086 11 8 9.20914 8 7C8 4.79086 9.79086 3 12 3C14.2091 3 16 4.79086 16 7Z" stroke="currentColor" stroke-width="1.5"/>
                                                    <path d="M12 14C8.13401 14 5 17.134 5 21H19C19 17.134 15.866 14 12 14Z" stroke="currentColor" stroke-width="1.5"/>
                                                </svg>
                                            </div>
                                ...
                                <td class="text-center">
                                    <div class="flex justify-center items-center gap-2">
                                        <a href="{{ route('superadmin.faskes-user.show', $user->id) }}" class="btn btn-sm btn-outline-info" title="Detail">
                                        ...
                                        <a href="{{ route('superadmin.faskes-user.edit', $user->id) }}" class="btn btn-sm btn-outline-warning" title="Edit">
                                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M15.2869 3.15178C14.3755 2.24025 12.8706 2.24025 11.9592 3.15178L4.83421 10.2768C4.65571 10.4553 4.7054 10.7431 4.9417 10.8477L8.11953 12.1884C8.20613 12.2153 8.27698 12.2862 8.30393 12.3728L9.64462 15.5506C9.74918 15.7869 10.037 15.8366 10.2155 15.6581L17.3405 8.53312C18.252 7.62158 18.252 6.11667 17.3405 5.20513L15.2869 3.15178Z" stroke="currentColor" stroke-width="1.5"/>
                                                <path d="M11.3214 16.0004L11.1736 16.1481L11.8509 17.7481C12.1321 18.3082 12.7066 18.6846 13.3448 18.6846H18.3448C18.8968 18.6846 19.3448 19.1326 19.3448 19.6846C19.3448 20.2366 18.8968 20.6846 18.3448 20.6846H13.3448C11.8868 20.6846 10.5657 19.7946 9.85075 18.4731L9.17345 16.8731L3.83421 14.2768C2.8255 13.7725 2.37634 12.5287 2.88064 11.52L5.51954 6.18086L8.73421 9.39553" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
                                            </svg>
                                        </a>
