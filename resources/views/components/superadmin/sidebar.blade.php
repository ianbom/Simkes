    ...
    <nav x-data="sidebar"
        ...
        <div class="bg-white dark:bg-[#0e1726] h-full">
            <div class="flex items-center justify-between px-4 py-3">
                <a href="/superadmin/dashboard" class="flex items-center main-logo shrink-0">
                    <img class="w-8 ml-[5px] flex-none" src="/assets/images/simkesia-logo.png" alt="image" />
                    <span
                        class="text-2xl ltr:ml-1.5 rtl:mr-1.5  font-semibold  align-middle lg:inline dark:text-white-light">SIMKESIA</span>
                </a>
                <a href="javascript:;"
            ...
            <ul class="perfect-scrollbar relative font-semibold space-y-0.5 h-[calc(100vh-80px)] overflow-y-auto overflow-x-hidden  p-4 py-0"
                ...
                <li class="menu nav-item">
                    <a href="/superadmin/dashboard" class="nav-link group">
                ...
                <li class="nav-item">
                    <ul>
                        <li class="nav-item">
                            <a href="/superadmin/provinsi" class="group">
                                <div class="flex items-center">
                                    <svg class="group-hover:!text-primary shrink-0" width="20" height="20"
                                        viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li class="nav-item">
                            <a href="/superadmin/kota" class="group">
                                <div class="flex items-center">
                        ...
                        <li class="nav-item">
                            <a href="/superadmin/kecamatan" class="group">
                                <div class="flex items-center">
                ...
                <li class="nav-item">
                    <ul>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('superadmin.faskes.index') }}" class="group">
                                <div class="flex items-center">
                                    ...
                                    <span
                                        class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Faskes</span>
                                </div>
                            </a>
                        </li>

                        <li class="nav-item">
                            <a href="{{ route('superadmin.faskes-user.index') }}" class="group">
                                <div class="flex items-center">
                                    ...
                                    <span
                                        class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Pengguna
                                        Faskes</span>
                                </div>
                            </a>
                        </li>
                ...
                <li class="nav-item">
                    <ul>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('superadmin.data.stuntingAnak') }}" class="group">
                                <div class="flex items-center">
                                    ...
                                    <span
                                        class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Balita</span>
                                </div>
                            </a>
                        </li>

                         <li class="nav-item">
                             <a href="{{ route('superadmin.data.stuntingJanin') }}" class="group">
                                <div class="flex items-center">
                                    ...
                                    <span
                                        class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Janin</span>
                                </div>
                            </a>
                        </li>
