...
import { RiwayatSakitAnak } from '@/types/interface';
...
interface Props {
    sickHistory?: RiwayatSakitAnak[];
}

export default function TabsRiwayatSakit({ sickHistory = [] }: Props) {
            ...
            <TabsContent value="medical-history" className="mt-6">
                <Card className="bg-white">
                    <CardHeader>
                        ...
                        <CardDescription>
                            Catatan lengkap riwayat sakit buah hati
                        </CardDescription>
                    </CardHeader>
                        ...
                        <Card className="bg-white shadow-sm">
                            ...
                            <CardContent>
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        type="text"
                                        placeholder="Cari nama anak, diagnosis, gejala, tindakan..."
                                        value={searchQuery}
                                        onChange={(e) =>
